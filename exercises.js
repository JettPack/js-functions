...
function checkSum(x) {
  return "Mariah Carey has been married " + x + " amounts of times."
}
...
var myFullName = createFullName("John", "Hoe" ) 
...
function eatFood(firstName, lastName, food) {
  return createFullName(firstName, lastName) +  ' eats '  + food + ' everynight in the dark' 
}

console.log(eatFood('Kristyne', 'Orangepillar', 'fried chicken'));
...
console.log(allCaps('harvey is happy'));
...
chain.replaceAll("true", "canDrink").replaceAll("false","can'tDrink")

console.log(verifyDrinkingAge(19));
